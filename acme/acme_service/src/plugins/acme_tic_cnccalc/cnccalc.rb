module ACME; module Plugins
  ...
  class CnCCalc
    ...
    def initialize(plugin)
      ...
      @plugin["/plugins/acme_host_communications/commands/cnccalc_reset/description"].data = 
        "Resets the CnCCalc database. params: none"
      @plugin["/plugins/acme_host_communications/commands/cnccalc_reset"].set_proc do |message, command|
      ...
      @plugin["/plugins/acme_host_communications/commands/cnccalc_newrun/description"].data = 
        "Creates a new entry in the CnCCalc database. params: type,name,desc"
      @plugin["/plugins/acme_host_communications/commands/cnccalc_newrun"].set_proc do |message, command|
      ...
      @plugin["/plugins/acme_host_communications/commands/cnccalc_dump/description"].data = 
        "Dump the CnCCalc database. params: filepath"
      @plugin["/plugins/acme_host_communications/commands/cnccalc_dump"].set_proc do |message, command|
