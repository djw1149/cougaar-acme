...
module FreeBASE
  ...
  class Configuration
    ...
    ##
    # Loads all the plugins based on the load list calculated by the depenency resolution
    #
    def load_plugins
      num = 0
    ...
    ##
    # Starts all the plugins based on the start list calculated by the depenency resolution
    #
    def start_plugins
      num = 0
    ...
    ##
    # Stops all the plugins based on reversing the start list calculated by the depenency resolution
    #
    def stop_plugins
    ...
    ##
    # Unloads all the plugins based on by reversing the load list calculated by the depenency resolution
    #
    def unload_plugins
  ...
  class SubsystemConfiguration
    attr_accessor :name, :version, :base_path
    attr_reader :plugins
    ...
    def configuration=(configuration)
      ...
      add_plugin do |plugin|
        ...
        plugin.require_path = "freebase/plugin"
  ...
  class PluginConfiguration
    ...
    attr_accessor :name, :version, :require_path, :properties_path, :startup_module, :resource_path, :base_path
