...
# reserved.
#
# $IPR: httprequest.rb,v 1.57 2002/09/22 11:53:34 gotoyuzo Exp $
...
module WEBrick
  ...
  class HTTPRequest
    ...
    def parse(socket=nil)
      ...
      read_header(socket) if @http_version.major > 0 
    ...
    def meta_vars
     ...
     #meta["REMOTE_IDENT"]      = nil      # no plan to be provided
      ...
      meta["HTTPS"]             = "on" if @config[:SSLEnable]
    ...
    def read_header(socket)
      ...
      @raw_header.each{|line|
        ...
        when /^\s+(.*?)\s*\z/om
          value = $1
          unless field
            message =  "bad header '#{line.inspect}'."
            raise HTTPStatus::BadRequest, message
          end
