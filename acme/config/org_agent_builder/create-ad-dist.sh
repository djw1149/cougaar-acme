...
ruby ../bin/transform_society.rb -i $ADDIR/small-1ad.facets.xml -r base_rules/temp -o $ADDIR/SMALL-TRANS.xml
ruby ../bin/transform_society.rb -i $ADDIR/small-1ad-trans-stub.facets.xml -r base_rules/temp -o $ADDIR/SMALL-TRANS-STUB.xml
ruby ../bin/transform_society.rb -i $ADDIR/small-1ad.facets.ammo.xml -r base_rules/temp -o $ADDIR/SMALL-TRANS-AMMO.xml
ruby ../bin/transform_society.rb -i $ADDIR/full-1ad.facets.xml -r base_rules/temp -o $ADDIR/FULL-TRANS.xml
ruby ../bin/transform_society.rb -i $ADDIR/full-1ad-trans-stub.facets.xml -r base_rules/temp -o $ADDIR/FULL-TRANS-STUB.xml
echo "Done"
