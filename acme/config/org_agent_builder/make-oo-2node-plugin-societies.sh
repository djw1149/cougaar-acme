...
# echo "Done"
echo "Making tiny-1ad.oo.2node.plugins.xml..."
ruby ../bin/transform_society.rb -i 1ad.orig-org-id/tiny-1ad.oo.2node.facets.xml -r base_rules/temp -o 1ad.orig-org-id/tiny-1ad.oo.2node.plugins.xml
echo "Done"
echo "Making tiny-1ad-trans-stub.oo.2node.plugins.xml..."
ruby ../bin/transform_society.rb -i 1ad.orig-org-id/tiny-1ad-trans-stub.oo.2node.facets.xml -r base_rules/temp -o 1ad.orig-org-id/tiny-1ad-trans-stub.oo.2node.plugins.xml
echo "Done"
