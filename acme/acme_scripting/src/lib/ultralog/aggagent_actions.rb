      ...
      def perform
        begin
          ...
          result = client.submit_query do |query|
            query.type = AggAgent::Query::TYPE_TRANSIENT
            ...
            query.predicate_spec = AggAgent::ScriptSpec.new_predicate_spec do |spec|
              spec.language = AggAgent::ScriptSpec::LANG_JAVA
            ...
            query.format_spec = AggAgent::ScriptSpec.new_format_spec do |spec|
              spec.language = AggAgent::ScriptSpec::LANG_JAVA
              spec.text = "org.cougaar.logistics.ui.stoplight.society.MetricFormatter"
              spec.format = AggAgent::ScriptSpec::FORMAT_INCREMENT
