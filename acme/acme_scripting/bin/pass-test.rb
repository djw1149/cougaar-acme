...
puts "[#{Time.now}] Passing Test: #{testId}"


description = ""
puts "Type the reason for passing this test, and press ^D (^Z in Windows) to finish."
...
server.call("remote.finishRun", testId.to_i, 1)